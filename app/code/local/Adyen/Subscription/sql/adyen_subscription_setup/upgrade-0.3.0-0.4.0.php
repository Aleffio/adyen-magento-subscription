...
$installer->run("
    ...
    ALTER TABLE `{$this->getTable('adyen_subscription/subscription')}`
        ...
        ADD CONSTRAINT `adyen_subscription_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE CASCADE,
        ADD CONSTRAINT `adyen_subscription_store_id` FOREIGN KEY (`store_id`) REFERENCES `core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE;
