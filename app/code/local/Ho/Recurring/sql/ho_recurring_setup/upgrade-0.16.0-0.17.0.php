...
$installer->addAttribute(Mage_Catalog_Model_Product::ENTITY, 'ho_recurring_type', array(
    'label'                      => 'Recurring Profile Type',
    'sort_order'                 => 10,
    'type'                       => 'int',
    'note'                       => '',
    'default'                    => null,                                                     // admin input default value
    'input'                      => 'select',                                                 // admin input type (select, text, textarea etc)
    'source'                     => 'ho_recurring/system_config_source_profile_type',
